...
def staff_add(request):
    if request.method == 'POST':
        ...
        probation_start_year_stage = request.POST.get('probationStartYearStage')
...
def staff_update(request, staffId):
    ...
    if employment_end_date_str:
        employment_end_date = datetime.datetime.strptime(employment_end_date_str, '%b. %d, %Y')
    ...
    if probation_start_date_str:
        probation_start_date = datetime.datetime.strptime(probation_start_date_str, '%b. %d, %Y')
        staff.probation_start_date = probation_start_date.date()
    
    staff.probation_start_year_stage = request.POST.get('probationStartYearStage')
